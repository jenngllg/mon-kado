...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("authentication_email_outbox", "public", t =>
                        {
                            ...
                            t.HasCheckConstraint(
                                "ck_authentication_email_outbox_deletion_request_consistent", "(kind = 'ACCOUNT_DELETION_CONFIRMATION') = (member_account_deletion_request_id IS NOT NULL)");
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Entities.MemberEmailChangeRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Entities.AuthenticationEmailOutboxMessage", b =>
                {
                    ...
                    b
                        .HasOne(
                        "JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Entities.MemberEmailChangeRequest", null)
                        .WithMany()
