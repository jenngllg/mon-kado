...
namespace JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Migrations
{
    ...
    [Migration("20260907142846_AddMemberPersonalDataExports")]
    partial class AddMemberPersonalDataExports
    {
        /// <inheritdoc/>
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresExtension(
                modelBuilder,
                "unaccent");
            NpgsqlModelBuilderExtensions.UseIdentityByDefaultColumns(modelBuilder);
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Domain.Entities.GiftReservation",
                b =>
                {
                    b
                        .Property<Guid>("Id")
                    ...
                    b
                        ...
                        .HasColumnName("xmin");
                    b
                        .Property<Guid>("WishId")
                        .HasColumnType("uuid")
                        .HasColumnName("wish_id");
                    b
                        .Property<Guid>("WishlistId")
                        .HasColumnType("uuid")
                        .HasColumnName("wishlist_id");
                    b
                        .Property<Guid>("WishlistParticipantId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Domain.Entities.GiftReservationHistory",
                b =>
                {
                    b
                        .Property<Guid>("Id")
                    ...
                    b.ToTable(
                        ...
                        t =>
                        {
                            t.HasCheckConstraint(
                                ...
                                "last_activity_at >= created_at AND ((status = 'Active' AND ended_at IS NULL) OR (status IN ('Cancelled', 'Unavailable') AND ended_at = last_activity_at))");
                            t.HasCheckConstraint(
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Domain.Entities.GuestSession",
                b =>
                {
                    b
                        .Property<Guid>("Id")
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Domain.Entities.Wish",
                b =>
                {
                    b
                        .Property<Guid>("Id")
                    ...
                    b
                        ...
                        .HasColumnName("created_at");
                    b
                        .Property<byte[]>("ImageContentHash")
                        .HasColumnType("bytea")
                    ...
                    b.ToTable(
                        ...
                        t =>
                        {
                            t.HasCheckConstraint(
                                ...
                                "(image_id IS NULL AND image_content_hash IS NULL) OR (image_id IS NOT NULL AND image_content_hash IS NOT NULL AND octet_length(image_content_hash) = 32)");
                            t.HasCheckConstraint(
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Domain.Entities.Wishlist",
                b =>
                {
                    b
                        .Property<Guid>("Id")
                    ...
                    b.ToTable(
                        ...
                        t =>
                        {
                            ...
                            t.HasCheckConstraint(
                                ...
                                "(NOT is_suspended AND suspension_reason IS NULL AND suspended_at IS NULL) OR (is_suspended AND suspension_reason IS NOT NULL AND char_length(btrim(suspension_reason)) > 0 AND suspended_at IS NOT NULL)");
                            t.HasCheckConstraint(
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Domain.Entities.WishlistModerationEvent",
                b =>
                {
                    b
                        .Property<Guid>("Id")
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Domain.Entities.WishlistParticipant",
                b =>
                {
                    b
                        .Property<Guid>("Id")
                    ...
                    b
                        ...
                        .HasColumnName("created_at");
                    b
                        .Property<string>("GuestDisplayName")
                        .IsRequired()
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)")
                        .HasColumnName("guest_display_name");
                    b
                        .Property<Guid?>("GuestSessionId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Domain.Entities.WishlistReport",
                b =>
                {
                    b
                        .Property<Guid>("Id")
                    ...
                    b
                        .Property<Guid?>("ReviewedByAdministratorId")
                        .HasColumnType("uuid")
                    ...
                    b
                        .HasIndex("ReviewedByAdministratorId")
                    ...
                    b.ToTable(
                        ...
                        t =>
                        {
                            ...
                            t.HasCheckConstraint(
                                ...
                                "(reviewed_at IS NULL AND status = 'Pending' AND review_note IS NULL AND reviewed_by_administrator_id IS NULL) OR (reviewed_at IS NOT NULL AND reviewed_at >= created_at)");
                            t.HasCheckConstraint(
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Domain.Entities.WishlistReportReviewEvent",
                b =>
                {
                    b
                        .Property<Guid>("Id")
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Domain.Entities.WishlistShareLink",
                b =>
                {
                    b
                        .Property<Guid>("Id")
                    ...
                    b
                        ...
                        .HasColumnName("created_at");
                    b
                        .Property<string>("ProtectedSecret")
                        .IsRequired()
                        .HasMaxLength(1024)
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Entities.AuthenticationEmailOutboxMessage",
                b =>
                {
                    b
                        .Property<Guid>("Id")
                    ...
                    b
                        .Property<DateTime?>("LockedUntil")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("locked_until");
                    b
                        .Property<Guid?>("MemberAccountDeletionRequestId")
                        .HasColumnType("uuid")
                        .HasColumnName("member_account_deletion_request_id");
                    b
                        .Property<Guid?>("MemberDataExportId")
                        .HasColumnType("uuid")
                        .HasColumnName("member_data_export_id");
                    b
                        .Property<Guid?>("MemberEmailChangeRequestId")
                        .HasColumnType("uuid")
                    ...
                    b
                        .Property<string>("SecurityStampSnapshot")
                        .HasMaxLength(256)
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Entities.AuthenticationSession",
                b =>
                {
                    b
                        .Property<Guid>("Id")
                    ...
                    b
                        .Property<byte[]>("RefreshTokenHash")
                        .IsRequired()
                        .HasColumnType("bytea")
                        .HasColumnName("refresh_token_hash");
                    b
                        .Property<DateTime>("RenewedAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.ToTable(
                        ...
                        t =>
                        {
                            ...
                            t.HasCheckConstraint(
                                ...
                                "renewed_at >= created_at AND expires_at > created_at AND expires_at >= renewed_at AND (revoked_at IS NULL OR revoked_at >= created_at)");
                        });
                });
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Entities.GiftImageDeletionOutboxMessage",
                b =>
                {
                    b
                        .Property<Guid>("Id")
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Entities.MemberAccountDeletionRequest",
                b =>
                {
                    b
                        .Property<Guid>("Id")
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Entities.MemberDataExport",
                b =>
                {
                    b
                        .Property<Guid>("Id")
                    ...
                    b
                        .Property<DateTime?>("FilesCleanedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("files_cleaned_at");
                    b
                        .Property<Guid?>("LeaseId")
                        .HasColumnType("uuid")
                    ...
                    b
                        ...
                        .HasColumnName("member_id");
                    b
                        .Property<DateTime?>("ReadyAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("ready_at");
                    b
                        .Property<long?>("SizeInBytes")
                        .HasColumnType("bigint")
                        .HasColumnName("size_in_bytes");
                    b
                        .Property<DateTime?>("SnapshotAt")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Entities.MemberEmailChangeRequest",
                b =>
                {
                    b
                        .Property<Guid>("Id")
                    ...
                    b
                        .Property<string>("NormalizedNewEmail")
                        .IsRequired()
                        .HasMaxLength(254)
                        .HasColumnType("character varying(254)")
                    ...
                    b.ToTable(
                        ...
                        t =>
                        {
                            ...
                            t.HasCheckConstraint(
                                ...
                                "expires_at > created_at AND (confirmed_at IS NULL OR confirmed_at >= created_at) AND (revoked_at IS NULL OR revoked_at >= created_at) AND NOT (confirmed_at IS NOT NULL AND revoked_at IS NOT NULL)");
                        });
                });
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Entities.MonKadoUser",
                b =>
                {
                    b
                        .Property<Guid>("Id")
                    ...
                    b
                        .Property<byte[]>("ProfileImageHash")
                        .HasColumnType("bytea")
                        .HasColumnName("profile_image_hash");
                    b
                        .Property<Guid?>("ProfileImageId")
                        .HasColumnType("uuid")
                    ...
                    b
                        .Property<DateTime?>("UnconfirmedAccountExpiresAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.ToTable(
                        ...
                        t =>
                        {
                            ...
                            t.HasCheckConstraint(
                                ...
                                "(profile_image_id IS NULL AND profile_image_hash IS NULL) OR (profile_image_id IS NOT NULL AND profile_image_hash IS NOT NULL AND octet_length(profile_image_hash) = 32)");
                            t.HasCheckConstraint(
                                "ck_users_timestamps_consistent",
                                "updated_at >= created_at AND (unconfirmed_account_expires_at IS NULL OR unconfirmed_account_expires_at >= created_at)");
                        });
                });
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Entities.WishPositionSequence",
                b =>
                {
                    b
                        .Property<Guid>("WishlistId")
            ...
            modelBuilder.Entity(
                "JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Entities.WishlistModerationEmail",
                b =>
                {
                    b
                        .Property<Guid>("Id")
