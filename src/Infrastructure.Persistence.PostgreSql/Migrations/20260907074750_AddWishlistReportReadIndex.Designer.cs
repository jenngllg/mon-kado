...
namespace JennGllg.Fr.MonKado.Back.Infrastructure.Persistence.PostgreSql.Migrations
{
    ...
    [Migration("20260907074750_AddWishlistReportReadIndex")]
    partial class AddWishlistReportReadIndex
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("authentication_email_outbox", "public", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_authentication_email_outbox_kind_valid", "kind IN ('EMAIL_CONFIRMATION', 'EMAIL_CHANGE_CONFIRMATION', 'EMAIL_CHANGE_SECURITY_NOTIFICATION', 'PASSWORD_RESET', 'PASSWORD_CHANGED_SECURITY_NOTIFICATION', 'ACCOUNT_DELETION_CONFIRMATION')");
