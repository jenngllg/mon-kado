...
public class DownloadAdministrativeDataExportQueryValidator : AbstractValidator<DownloadAdministrativeDataExportQuery>
{
    /// <summary>Initializes the centralized validation rules.</summary>
    public DownloadAdministrativeDataExportQueryValidator()
    {
