    ...
    IPAddress? remoteIpAddress = null) : WebApplicationFactory<Program>
{
    ...
    public RecordingAuthenticatedMemberValidationService MemberValidationService { get; } = new();
    ...
    {
        var allowedOrigin = environment == "Production" ? "https://localhost" : "http://localhost:5173";
        ...
        builder.ConfigureServices(services =>
            {
                services.RemoveAll<IAuthenticatedMemberValidationService>();
                services.AddSingleton<IAuthenticatedMemberValidationService>(MemberValidationService);
