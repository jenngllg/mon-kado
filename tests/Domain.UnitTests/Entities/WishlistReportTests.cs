...
public class WishlistReportTests
{
    ...
    public void Review_WhenDispositionOrNoteChanges_UpdatesOnlyReviewMetadata(
        ...
        string? normalized)
    {
        ...
        Assert.Equal(
            administratorId,
            report.ReviewedByAdministratorId);
        Assert.Equal(
            "Original visitor text",
            report.Details);
        Assert.Equal(
    ...
    public void Review_WhenNormalizedDecisionIsUnchanged_PreservesOriginalReviewerAndDate(
        string? firstNote,
        string? repeatedNote)
    {
        // Arrange
