...
public class DownloadAdministrativeDataExportQueryValidatorTests
{
    private readonly DownloadAdministrativeDataExportQueryValidator _validator = new();
    [Theory]
