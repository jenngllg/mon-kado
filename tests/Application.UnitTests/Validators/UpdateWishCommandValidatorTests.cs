...
public class UpdateWishCommandValidatorTests
{
    private readonly UpdateWishCommandValidator _validator = new();
    ...
    [Theory]
    [InlineData(true, false, false, nameof(UpdateWishCommand.OwnerId))]
    [InlineData(false, true, false, nameof(UpdateWishCommand.WishlistId))]
    [InlineData(false, false, true, nameof(UpdateWishCommand.WishId))]
