...
public class RevokeMemberSessionsCommandValidatorTests
{
    private readonly RevokeMemberSessionsCommandValidator _validator = new();
    [Theory]
    [InlineData(null, false)]
    [InlineData("", false)]
    [InlineData("   ", false)]
    [InlineData("SUPPORT-809\n", false)]
    [InlineData("\tSUPPORT-809", false)]
    [InlineData("SUPPORT\u0000808", false)]
    [InlineData(" SUPPORT-809 ", true)]
        ...
        bool valid)
    {
        ...
        var command = new RevokeMemberSessionsCommand(
            Guid.CreateVersion7(),
            memberId,
            memberId,
            reference);
    ...
    public async Task ValidateAsync_WhenIdentifiersAndReferenceAreMissing_AggregatesErrors()
    {
        ...
        // Assert
        Assert.Equal(
            ["AdministratorId", "ConfirmedMemberId", "MemberId", "RequestReference"],
            result.Errors
