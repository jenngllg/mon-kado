...
$requiredModules = @(
    ...
    'JennGllg.Fr.MonKado.Back.Infrastructure.Observability',
    'JennGllg.Fr.MonKado.Back.Infrastructure.PersonalDataExports',
    'JennGllg.Fr.MonKado.Back.Infrastructure.UrlImport',
